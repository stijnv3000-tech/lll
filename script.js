...
(function () {
  ...
  var I18N_EN = {
    ...
    ph_address: "Brabançonnestraat 32, 3000 Leuven", ph_email: "info@digital-impression.be", ph_phone: "+32 496 25 14 45", news_ph: "Your email",
    ...
    about_badge: "Based in Belgium", about_eyebrow: "About Us", about_title: "What Is <em>Digital Impression?</em>",
    about_intro: "Digital Impression is a Belgian web design studio that helps local entrepreneurs get a website that doesn't just look beautiful, but actually wins customers. No anonymous foreign supplier — a dedicated, local point of contact who thinks along with you, from first conversation to launch and beyond.",
